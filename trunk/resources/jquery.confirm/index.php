...
<link
	href='http://fonts.googleapis.com/css?family=Cuprum&amp;subset=latin'
...
<body>
	...
	<div id="page">
		...
		<div class="item">
			<a href="http://tutorialzine.com/?p=<?php echo $t['id']?>"> <img
				src="http://cdn.tutorialzine.com/img/featured/<?php echo $t['id']?>.jpg"
				title="<?php echo $t['title']?>" alt="<?php echo $t['title']?>"
	...
	<div id="footer">
		...
		<a class="tzine"
			href="http://tutorialzine.com/2010/12/better-confirm-box-jquery-css3/">Read
			&amp; Download on</a>
	</div>
