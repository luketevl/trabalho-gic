...
<form action="../intranet/posts_cadastro/load_form_edit" method="get"
	...
	<section id="list">
		...
		<section id="infoList">
			<img src="<?php echo base_url();?>resources/icons/menu.png" /> <a
				href="#" class="active" name="novo">{cc_aberto} Novos </a> | <a
				href="#" class="active" name="aprovado">{cc_aprovado} Aprovados </a>
			| <a href="#" class="active" name="rejeitado">{cc_rejeitado}
				Rejeitados </a> | <a href="#" class="active" name="publicado">{cc_publicado}
				Publicados </a>
		</section>
		<hr />
		<table>
