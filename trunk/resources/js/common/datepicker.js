...
//								$('<a href="#" class="selecteee">aaa</a>'),
								...
								$('<div class="dp-nav-prev"></div>')
									.append(
										...
										$('<a class="dp-nav-prev-month" href="#" title="' + $.dpText.TEXT_PREV_MONTH + '">&laquo;</a>')
											.bind(
												'click',
												function()
												{
								...
								$('<div class="dp-nav-next"></div>')
									.append(
										...
										$('<a class="dp-nav-next-month" href="#" title="' + $.dpText.TEXT_NEXT_MONTH + '">&raquo;</a>')
											.bind(
												'click',
												function()
												{
				...
				if (!c.inline) {
					...
					if (this.verticalPosition == $.dpConst.POS_BOTTOM) {
						...
						var pos		= eleOffset.top + $pop.outerHeight() + c.verticalOffset;
						var diff 	= ($h < pos) ? $h - pos - 15 : 0;
						$pop.css('top', eleOffset.top + c.verticalOffset + diff);
					}
					...
					if (this.horizontalPosition == $.dpConst.POS_RIGHT) {
						...
						var pos		= eleOffset.left + $pop.outerWidth() + c.horizontalOffset;
						var diff 	= ($w < pos) ? $w - pos - 23 : 0;
						$pop.css('left', eleOffset.left + c.horizontalOffset + diff);
					}
