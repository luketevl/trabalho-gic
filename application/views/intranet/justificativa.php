...
echo form_textarea('justificativa','','class="required" style="width:100%;"');
echo form_close();
...
echo form_button('cancelar','<img src='. base_url() .'resources/icons/cancel2.png width= 22 height= 22 /> <span></span>','class="tooltip btn btn-large btn-block btn-primary tooltip" title="'.lang('btn_cancelar').'"');
