...
<body>
	...
	<nav id="user">
		...
		<span id="circle" class="tooltip" title="<?php echo $tp_posts;?>"> <img
			src="<?php echo base_url();?>resources/icons/post3.png" />
			<p>2</p>
		</span> <span id="circle" class="tooltip"
			title="<?php echo $tp_posts;?>"> <img
			src="<?php echo base_url();?>resources/icons/post3.png" />
			<p>2</p>
		</span>
	</nav>
	...
	<div id="sidr">
		...
		<ul>
			...
			</a> <?php echo form_hidden('hd_link',$categorias['url']);?>
			</li>
