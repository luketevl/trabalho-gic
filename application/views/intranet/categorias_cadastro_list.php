...
<form method="post" action="mostrar.php" id="form">
 ...
 -->
 <form action="../intranet/categorias_cadastro/load_form_edit" method="get" accept-charset="utf-8">
...
<!--  	</section> -->
 	...
 	<table>
		 ...
		 {dados}
 		<tr>
 			<td style="display: none" name="hd_id" >{id_cat}</td>
 			<td>{nome_cat}</td>
 			<td class="center" >{categoria_mae}</td>
 		</tr>
 		 {/dados}
 		</tbody>
